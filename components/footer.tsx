  ...
  const footerNav = [
    {
      ...
      links: [
        { href: h("#features"), label: t.footer.links.features },
        { href: h("#product"), label: t.footer.links.product },
        { href: h("#pricing"), label: t.footer.links.pricing },
        { href: docsPath(lang), label: t.footer.links.docs },
      ],
    },
    {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between md:gap-12">
          <div className="mx-auto max-w-md text-center sm:mx-0 sm:max-w-xs sm:text-left">
            <Link
              href={homeHref}
              className="inline-flex items-center justify-center gap-2 rounded-md outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:justify-start"
            >
            ...
            <div className="mt-3 flex justify-center gap-2 sm:justify-start sm:gap-3">
              {socialLinks.map((social) => (
                <Link
                  ...
                  className="flex h-10 w-10 touch-manipulation items-center justify-center rounded-lg text-muted-foreground outline-none transition-colors hover:bg-white/5 hover:text-foreground focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:h-9 sm:w-9"
                  ...
                  >
                    {section.links.map((link) => (
                      <li key={link.label}>
                        <Link
                          href={link.href}
                          className="rounded text-sm text-muted-foreground outline-none transition-colors hover:text-foreground focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                        >
                          {link.label}
                        </Link>
                      </li>
        ...
        <div className="mt-8 border-t border-white/5 pt-6 sm:mt-10 sm:pt-8">
          ...
          <p className="mt-3 text-center text-[11px] leading-relaxed text-muted-foreground/70 sm:text-xs">
            {t.footer.disclaimer}
          </p>
        </div>
      </div>
